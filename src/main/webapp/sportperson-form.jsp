...
<body>
	...
	<div class="container ">
		<h1 class="mb-4 text-center">Add SportPerson</h1>

		<form action="sportperson?action=insert" method="post">
			<div class="form-group">
				<label for="sportpersonid">Sportperson ID:</label> 
				<input type="text" id="sportpersonid" name="sportpersonid" class="form-control"
					value="${sportperson.sportpersonid}" required>
			</div>

			<div class="form-group">
				<label for="name">Name:</label> 
				<input type="text" id="name" name="name" class="form-control" 
					value="${sportperson.name}" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="date" id="dob" name="dob" class="form-control"
					value="${sportperson.dob}" required>
			</div>

			<div class="form-group">
				<label for="age">Age:</label> 
				<input type="number" id="age" name="age" class="form-control" 
					value="${sportperson.age}" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="email" id="email" name="email" class="form-control" 
					value="${sportperson.email}" required>
			</div>

			<div class="form-group">
				<label for="phone">Phone:</label> 
				<input type="text" id="phone" name="phone" class="form-control" 
					value="${sportperson.phone}" required>
			</div>

			<div class="form-group">
				<label for="address">Address:</label> 
				<input type="text" id="address" name="address" class="form-control"
					value="${sportperson.address}" required>
			</div>

			<div class="form-group">
				<label for="nationality">Nationality:</label> 
				<input type="text" id="nationality" name="nationality" class="form-control"
					value="${sportperson.nationality}" required>
			</div>

			<button type="submit" class="btn btn-primary">Add New SportPerson</button>
