<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*, coachAttendance.CoachAttendance"%>
<%@ page import="coachAttendance.CoachAttendanceDAO"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="container ">
		<h1 class="mb-4 text-center">View Coach Attendance</h1>

		<!-- Form to select date -->
		<form action="coachViewAttendance.jsp" method="get">
		...
		if (date != null && !date.isEmpty()) {
			CoachAttendanceDAO attendanceDAO = new CoachAttendanceDAO();
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<%
				for (CoachAttendance attendance : attendanceList) {
				%>
				<tr>
					<td><%=attendance.getCoachid()%></td>
